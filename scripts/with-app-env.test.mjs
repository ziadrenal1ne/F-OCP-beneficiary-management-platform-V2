...
test("bare commands resolve to the local .bin executable before PATH lookup", () => {
...
test("the CLI still runs when invoked through a symlinked path", async () => {
  ...
  // Windows often blocks creating symlinks without elevated privileges, so skip
  // the permission-denied case instead of failing the workspace on non-admin hosts.
