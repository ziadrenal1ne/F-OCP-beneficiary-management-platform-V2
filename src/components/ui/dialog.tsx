...
function DialogContent({ className, children, ...props }: React.ComponentProps<typeof DialogPrimitive.Content>) {
  return (
    <DialogPortal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md opacity-60 outline-none transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring">
          <X className="h-4 w-4" />
